    ...
    <div className="min-h-screen">
            ...
            <div className="container mx-auto max-w-6xl space-y-16">
              ...
              <div className="text-center space-y-6 animate-fade-in">
                ...
                <p className="text-xl text-foreground leading-relaxed max-w-3xl mx-auto">
                  Los exoplanetas son planetas que están fuera de nuestro
                  Sistema Solar, girando alrededor de otras estrellas en el
                  universo. ¡Hay miles de ellos esperando ser descubiertos!
                </p>
              </div>
                ...
                <div className="card-cosmic p-6 space-y-4">
                  ...
                  <div className="aspect-video bg-accent/10 rounded-lg flex items-center justify-center border border-primary/20">
                    <iframe
                      ...
                      src="https://www.youtube.com/embed/cB3aF47Aoxs"
              ...
              <div className="grid md:grid-cols-2 gap-6 animate-fade-in">
                <div className="card-cosmic p-6 space-y-4 hover-scale">
                  ...
                  <p className="text-muted-foreground">
                    ¡Es como cuando pasa un pájaro frente al sol! Cuando un
                    planeta pasa delante de su estrella, la luz de la estrella
                    se hace un poquito más débil. ¡Así sabemos que hay un
                    planeta ahí!
                  </p>
                </div>
                ...
                <div className="card-cosmic p-6 space-y-4 hover-scale">
                  ...
                  <p className="text-muted-foreground">
                    Las estrellas y planetas bailan juntos en el espacio. Cuando
                    un planeta grande gira alrededor de una estrella, hace que
                    la estrella se mueva un poquito. ¡Podemos medir ese
                    movimiento!
                  </p>
                </div>
                ...
                <div className="card-cosmic p-6 space-y-4 hover-scale">
                  ...
                  <p className="text-muted-foreground">
                    ¡Es el telescopio espacial más poderoso! Puede ver cosas
                    súper lejanas y detectar qué gases hay en otros planetas.
                    ¡Está en el espacio tomando fotos increíbles!
                  </p>
                </div>
                ...
                <div className="card-cosmic p-6 space-y-4 hover-scale">
                  ...
                  <p className="text-muted-foreground">
                    Es un satélite canadiense que busca asteroides y también
                    ayuda a encontrar exoplanetas. ¡Es como un guardián espacial
                    que vigila objetos cerca de la Tierra!
                  </p>
                </div>
              </div>
              ...
              <div className="card-cosmic p-8 space-y-6 animate-fade-in">
                <h3 className="text-3xl font-bold text-center glow-text">
                  📊 Datos Divertidos
                </h3>
              ...
              <div className="max-w-4xl mx-auto animate-fade-in">
                <div className="card-cosmic p-6 space-y-4">
                  ...
                  <div className="aspect-video bg-accent/10 rounded-lg flex items-center justify-center border border-primary/20">
                    <iframe
                      className="w-full h-full rounded-lg"
                      src="https://www.youtube.com/embed/Twv6bjNbWxk"
              ...
              <div className="animate-fade-in">
                <h3 className="text-3xl font-bold text-center glow-text mb-8">
                  🎨 Gráficas Coloridas
                </h3>
      ...
      {viewMode !== "kids" ? (
        <div className="container mx-auto max-w-4xl py-8 space-y-8">
          <Card className="card-cosmic">
            <CardHeader>
              <CardTitle className="glow-text">Real-time API Status</CardTitle>
            </CardHeader>
          ...
          <Card className="card-cosmic">
            <CardHeader>
              <CardTitle className="glow-text">Batch API Status</CardTitle>
            </CardHeader>
            <CardContent className="flex items-center space-x-4">
      ...
      <footer className="py-8 border-t border-border mt-16">
        <div className="container mx-auto text-center text-muted-foreground">
          <p>
            Explorador de Exoplanetas - Datos científicos para investigadores
          </p>
        </div>
      </footer>
    </div>
