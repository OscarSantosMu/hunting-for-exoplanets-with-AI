    ...
    <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto animate-fade-in">
        ...
        <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto mb-8">
          Descubre mundos más allá de nuestro sistema solar. Explora datos científicos, 
          visualiza patrones y comprende las características de planetas distantes.
        </p>
        ...
        <div className="flex flex-wrap gap-4 justify-center text-sm md:text-base">
          ...
          <div className="px-6 py-3 rounded-lg bg-card/50 backdrop-blur-sm border border-border">
            <span className="text-primary font-bold">Multiple</span> Métodos de Detección
          </div>
        </div>
      </div>
    </section>
